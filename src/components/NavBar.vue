        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              ...
              <router-link to="/" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" active-class="bg-gray-900" exact-active-class="bg-gray-900">Home</router-link>
